...
module.exports = {
    ...
    LG_LOGO: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/TR4CYrZ.jpg' : process.env.ALL_IMG,
    LG_NAME: process.env.ALL_NAME === undefined ? 'sᴀɴᴀ ᴍᴡᴏʟ' : process.env.ALL_NAME,
